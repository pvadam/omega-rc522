...
class MFRC522:
  ...
  def __init__(self, dev='/dev/spidev0.0', spd=1000000):
    ...
    print 'SPI Speed: %d Hz (%d kHz)'%(self.spi.speed, self.spi.speed/1000)
    print 'Mode: %d, Mode Bits: 0x%x, CS-High: %d'%(self.spi.mode, self.spi.modeBits, self.spi.csHigh)
  ...
  def Read_MFRC522(self, addr):
    ...
    val = self.spi.readBytes(((addr<<1)&0x7E) | 0x80, 2)
    return val[1]
